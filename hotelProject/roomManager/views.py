...
def info(request):
    ...
    class RoomTypeFactory(factory.Factory):
        ...
        type_name_ar = factory.LazyAttribute(
            lambda _: fake.random.choice(['غرفه مفرده', 'غرفة توأم','غرفة مزدوجة ',
                 'غرفه ثلاثيه', 'غرفه رباعيه','مزدوج مزدوجة ثنائية', 'غرفة الملكة','جناح' ,
                'جناح الرئيس | الجناح الرئاسي', 'الاستوديو',
                 'الغرف المتصلة','جناح صغير' ]))
        ...
        bedType_ar = factory.LazyAttribute(
            lambda _: fake.random.choice(['سرير لفردين',
                  '1 سرير لفردين و 1 سرير أريكة',
                  '2 سرير لفرد واحد', '1 سرير أريكة 1 سرير لفرد واحد', ' سرير كبير لفردين', ]))
