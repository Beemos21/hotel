...
from roomManager.models import Room, RoomType, Service
...
class Reservation(models.Model):
    ...
    _total_cost = models.DecimalField(max_digits=10, decimal_places=3)
    currency = models.ForeignKey(Currency,  on_delete=models.CASCADE)
    _discounted_price = models.DecimalField(max_digits=10, decimal_places=3)
